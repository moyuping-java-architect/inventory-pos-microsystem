...
public class StockProcessCompletedListener {
    ...
    private String getDefaultSkuCode(String goodsCode) {
        ...
        try {
            List<String> results = jdbcTemplate.queryForList(
                    "SELECT sku_code FROM goods_sku WHERE goods_code = ? LIMIT 1",
    ...
    @LocalMqHandler(routingKey = RabbitMQConstant.PROCESS_COMPLETED_LOSS_ROUTING_KEY)
    ...
    @SuppressWarnings("unchecked")
    @LocalMqHandler(routingKey = RabbitMQConstant.PROCESS_COMPLETED_OVERFLOW_ROUTING_KEY)
    ...
    @SuppressWarnings("unchecked")
    @LocalMqHandler(routingKey = RabbitMQConstant.PROCESS_COMPLETED_CHECK_ROUTING_KEY)
    ...
    @SuppressWarnings("unchecked")
    @LocalMqHandler(routingKey = RabbitMQConstant.PROCESS_COMPLETED_STOCK_ROUTING_KEY)
