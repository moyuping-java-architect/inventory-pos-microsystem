...
import com.psi.stock.mapper.StockSyncLogMapper;
...
public class StockSyncProducer {
    ...
    private final StockSyncLogMapper syncLogMapper;
    ...
    public StockSyncProducer(MqMessageFacade mqMessageFacade, ObjectMapper objectMapper,
                             ...
                             @Lazy InventoryInitItemService inventoryInitItemService, StockSyncLogMapper syncLogMapper) {
    ...
    private String getLastUploadTime() {
        try {
            StockSyncLogEntity logEntity = syncLogMapper.selectByType(SYNC_TYPE_UP);
    ...
    private void updateLastUploadTime(String lastTime) {
        try {
            ...
            if (logEntity != null) {
                ...
                logEntity = new StockSyncLogEntity();
