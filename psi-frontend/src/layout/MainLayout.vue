        ...
        >
          ...
          <el-sub-menu index="/customer">
            <template #title>
              ...
              <span>{{ t('menu.customerJourney') }}</span>
            </template>
            <el-menu-item index="/customer/dashboard">{{ t('menu.customerDashboard') }}</el-menu-item>
            <el-menu-item v-if="canSeePricing" index="/customer/config">{{ t('menu.customerConfig') }}</el-menu-item>
            <el-menu-item index="/customer/script-library">{{ t('menu.scriptLibrary') }}</el-menu-item>
            <el-menu-item index="/customer/match-rule">{{ t('menu.matchRule') }}</el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="/system">
            ...
            <el-menu-item v-if="canSeePricing" index="/system/pricing">{{ t('menu.pricingConfig') }}</el-menu-item>
          </el-sub-menu>
...
const canSeePricing = computed(() => isAdmin())
...
const currentTitle = computed(() => {
  const titles = {
    ...
    '/customer/dashboard': t('menu.customerDashboard'),
    '/customer/config': t('menu.customerConfig'),
    ...
    '/system/pricing': t('menu.pricingConfig'),
