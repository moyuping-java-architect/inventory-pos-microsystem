...
export function useDocDraft(options = {}) {
  ...
  const getWorkflowProcessCode = (type) => {
    const map = {
      ...
      'PURCHASE_IN': 'purchase_in_approval',
      'PURCHASE_RETURN': 'purchase_return_approval',
      'SALE_ORDER': 'sale_order_approval',
      'SALE_OUT': 'sale_out_approval',
      'SALE_RETURN': 'sale_return_approval',
      'STOCK_LOSS': 'stock_loss_approval',
      'STOCK_OVERFLOW': 'stock_overflow_approval',
      'STOCK_CHECK': 'stock_check_approval',
      'STOCK_TRANSFER': 'stock_transfer',
      'INVENTORY_INIT': 'inventory_init_approval',
      'ADJUST_PRICE': 'adjust_price_approval'
    }
