      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'config',
            name: 'CustomerConfig',
            component: () => import('../views/customer/Config.vue'),
            meta: {
              roles: ['SUPER_ADMIN', 'ADMIN'],
              title: 'menu.customerConfig'
            }
          },
          {
            path: 'script-library',
            name: 'ScriptLibrary',
            component: () => import('../views/customer/ScriptLibrary.vue'),
            meta: {
              title: 'menu.scriptLibrary'
            }
          },
          {
            path: 'match-rule',
            name: 'MatchRule',
            component: () => import('../views/customer/MatchRule.vue'),
            meta: {
              title: 'menu.matchRule'
            }
          }
        ]
      },
