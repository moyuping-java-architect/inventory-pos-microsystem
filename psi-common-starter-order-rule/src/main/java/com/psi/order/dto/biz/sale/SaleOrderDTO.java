package com.psi.order.dto.biz.sale;
...
/**
 * 销售订单DTO
 * 参照 sale_order_main / sale_order_item 正式表结构
 */
@Data
...
public class SaleOrderDTO {
    ...
    @Schema(description = "销售类型：1-普通销售 2-批发 3-零售")
    private Integer saleType;

    @Schema(description = "付款方式：1-现金 2-刷卡 3-赊销")
    ...
    public static SaleOrderDTO fromEntity(DocEntity entity, List<DocItemEntity> itemEntities) {
        ...
        dto.setCustomerId(entity.getPartnerId());
        dto.setCustomerCode(entity.getPartnerCode());
        dto.setCustomerName(entity.getPartnerName());
    ...
    public static SaleOrderDTO fromResponse(DocResponse response) {
        SaleOrderDTO dto = new SaleOrderDTO();
        dto.setId(response.getId());
        dto.setDocNo(response.getDocNo());
        dto.setShopCode(response.getShopCode());
        dto.setShopName(response.getShopName());
        dto.setCustomerId(response.getPartnerId());
        dto.setCustomerCode(response.getPartnerCode());
        dto.setCustomerName(response.getPartnerName());
        ...
        dto.setSaleType(response.getSaleType());
