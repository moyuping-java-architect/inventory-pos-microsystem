...
/**
 * 销售出库单DTO
 * 参照 sale_out_main / sale_out_item 正式表结构
 */
@Data
@Schema(description = "销售出库单DTO")
public class SaleOutDTO {
    ...
    public static SaleOutDTO fromEntity(DocEntity entity, List<DocItemEntity> itemEntities) {
        SaleOutDTO dto = new SaleOutDTO();
    ...
    public static SaleOutDTO fromResponse(DocResponse response) {
        SaleOutDTO dto = new SaleOutDTO();
