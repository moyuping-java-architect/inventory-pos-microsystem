...
/**
 * 销售退货单DTO
 * 参照 sale_return_main / sale_return_item 正式表结构
 */
@Data
@Schema(description = "销售退货单DTO")
public class SaleReturnDTO {
    ...
    public static SaleReturnDTO fromEntity(DocEntity entity, List<DocItemEntity> itemEntities) {
    ...
    public static SaleReturnDTO fromResponse(DocResponse response) {
        SaleReturnDTO dto = new SaleReturnDTO();
