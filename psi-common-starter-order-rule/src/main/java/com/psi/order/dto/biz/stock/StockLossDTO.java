...
/**
 * 报损单DTO
 * 参照 stock_loss_main / stock_loss_item 正式表结构
 */
@Data
@Schema(description = "报损单DTO")
public class StockLossDTO {

    @Schema(description = "草稿ID")
    private Long id;

    @Schema(description = "报损单编号")
    ...
    public static StockLossDTO fromEntity(DocEntity entity, List<DocItemEntity> itemEntities) {
    ...
    public static StockLossDTO fromResponse(DocResponse response) {
        StockLossDTO dto = new StockLossDTO();
