...
/**
 * 采购入库单DTO
 * 参照 purchase_in_main / purchase_in_item 正式表结构
 */
@Data
@Schema(description = "采购入库单DTO")
public class PurchaseInDTO {
    ...
    public static PurchaseInDTO fromEntity(DocEntity entity, List<DocItemEntity> itemEntities) {
    ...
    public static PurchaseInDTO fromResponse(DocResponse response) {
        PurchaseInDTO dto = new PurchaseInDTO();
