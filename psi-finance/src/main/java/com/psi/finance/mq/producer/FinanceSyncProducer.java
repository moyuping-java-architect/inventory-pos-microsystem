...
import com.psi.finance.mapper.FinanceSyncLogMapper;
...
public class FinanceSyncProducer {
    ...
    private final FinanceSyncLogMapper syncLogMapper;
    ...
    private String getLastUploadTime() {
        FinanceSyncLogEntity logEntity = syncLogMapper.selectByType("up");
        if (logEntity != null) {
    ...
    private void updateLastUploadTime(String lastTime) {
        ...
        if (logEntity != null) {
            ...
            logEntity = new FinanceSyncLogEntity();
