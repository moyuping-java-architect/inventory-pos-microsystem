...
import com.psi.purchase.mapper.PurchaseSyncLogMapper;
...
public class PurchaseSyncProducer {
    ...
    private final PurchaseSyncLogMapper syncLogMapper;
    ...
    public PurchaseSyncProducer(MqMessageFacade mqMessageFacade,
                                ...
                                PurchaseSyncLogMapper syncLogMapper,
    ...
    private String getLastUploadTime() {
        PurchaseSyncLogEntity syncLog = syncLogMapper.selectByType(SYNC_TYPE_UP);
    ...
    private void updateLastUploadTime(String lastTime) {
        PurchaseSyncLogEntity syncLog = syncLogMapper.selectByType(SYNC_TYPE_UP);
        if (syncLog == null) {
            PurchaseSyncLogEntity entity = new PurchaseSyncLogEntity();
