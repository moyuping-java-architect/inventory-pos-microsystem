...
public class MyBatisProperties {
    ...
    public static class Tenant {
        ...
        private List<String> whitelistTables = List.of(
                ...
                "sys_tenant",
                "operator",
                "customer_journey_config",
                // 客户旅程引擎的配置层：出厂预置规则 tenant_id 为空，
                // 租户自定义规则带自己的 tenant_id。这里放开自动过滤，
                // 改由引擎按「全局规则 + 本租户规则」自行控制可见范围，
                // 否则出厂预置配置对任何租户都查不到，引擎等于空转。
                "business_event_dict",
                "journey_dict",
                "touchpoint_generate_rule",
