...
public class SysLoginServiceImpl implements SysLoginService {
    ...
    private UserInfo buildUserInfo(SysUser user) {
        ...
        userInfo.setShopId(user.getShopId() != null ? String.valueOf(user.getShopId()) : null);
        userInfo.setWarehouseId(user.getWarehouseId() != null ? String.valueOf(user.getWarehouseId()) : null);
