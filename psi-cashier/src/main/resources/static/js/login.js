...
const LoginModule = (function() {
    ...
    function handleLoginSuccess(data) {
        ...
        // 备用：从响应体获取信息（响应头可能因非ASCII字符被Tomcat丢弃）
        ...
        if (data.user && data.user.id && !localStorage.getItem('cashier_user_id')) {
            localStorage.setItem('cashier_user_id', data.user.id);
        }
        if (data.user && data.user.realName && !localStorage.getItem('cashier_user_name')) {
            localStorage.setItem('cashier_user_name', data.user.realName);
        }
